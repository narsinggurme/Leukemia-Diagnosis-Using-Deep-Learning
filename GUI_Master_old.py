...
#
lbl = tk.Label(root, text="Leukamia Disease Detection System", font=('times', 35,' bold '), height=1, width=32,bg="seashell2",fg="Black")
...
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=350, bd=5, font=('times', 14, ' bold '),bg="hot pink")
...
#    global fn
    ...
    if fn!="":
        ...
        leukemia=np.argmax(prediction)
        print(leukemia)
        
        
        
        if leukemia == 0:
            Cd="Leukemia Detected in Patient"
        elif leukemia == 1:
            Cd="Normal Patient"
