...
path1 = 'D:/All Code/Project Done/Leukemia Detection/Leukemia Detection/test_set/1'    #path of folder of images    
path2 = 'D:/All Code/Project Done/Leukemia Detection/Leukemia Detection/test_set/1'  #path of folder to save images    
