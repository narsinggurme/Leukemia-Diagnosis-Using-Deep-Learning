def main():
    ...
    basepath="C:/Users/narsi/OneDrive/Desktop/BE Project group 5/projet 100%"
    
    # Initialing the CNN
    classifier = Sequential()
    
    # Step 1 - Convolutio Layer 
    classifier.add(Convolution2D(64, 1,  1, input_shape = (64, 64, 3), activation = 'relu'))
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/leukemia_model.h5')
